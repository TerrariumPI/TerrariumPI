...
#
# However, when we do this, we also import `TerrariumPI/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'TerrariumPI_cli = TerrariumPI.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'TerrariumPI_gui = TerrariumPI.gui:entry_point'
        # ]
    }
)
